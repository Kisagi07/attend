...
const SalaryPage = () => {
  ...
  return (
    <section className="space-y-4">
      ...
      <input
        type="month"
        className="px-2 py-1 w-full border border-gray-200 outline-none rounded "
        value={monthYear}
        onChange={(e) => setMonthYear(e.currentTarget.value)}
      />
      <TotalEmployeeCard />
      ...
      <article className="border border-gray-200 rounded p-4 flex justify-between items-center">
        ...
        <FaMoneyCheck className="w-12 h-12 bg-emerald-400 text-white p-4 rounded-full" />
      </article>
    </section>
  );
};
